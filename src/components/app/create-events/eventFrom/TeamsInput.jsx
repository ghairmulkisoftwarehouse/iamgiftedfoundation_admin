...
import { setStats,setMultipleTeamDetails,removeTeamDetail} from "../../../../redux/slices/teamSlice";
...
const TeamsInput = ({
  ...
  const { isLoading, isError } = useQuery(
    ["fetch-all-team", searchTerm],
    async () => {
      let url = `/team?sortBy=createdAt_descending`;
...
const handleSelect = (item) => {
  if (!isSelected(item._id)) {
    ...
    onChange(updated);
    dispatch(setMultipleTeamDetails(updated)); 
  }
};
