...
export const menuItems = [
  ...
  { name: "Events", icon: EventSvg ,path : '/' },
  { name: "Programs", icon: ProgramsSvg,path : '/' },
  { name: "Donations", icon: DonationSvg,path:'/app/donations' },
  { name: "Peer-to-Peer Fundraising", icon: PeertoPeerSvg,path : '/' },
  { name: "Community", icon: CommunitySvg,path : '/app/community' },
  { name: "Teams", icon: CommunitySvg ,path : '/app/teams' },
  { name: "Panel User", icon: PanelUserSvg,path : '/' },
